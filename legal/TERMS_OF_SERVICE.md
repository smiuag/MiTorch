...
- **We do not control** the content, availability, or policies of MUD servers
- **Each server is independent** with its own rules and terms
- **You are responsible** for complying with each server's specific terms
- **We are not liable** for server downtime, data loss, or content
- You must read and agree to each server's terms before connecting
...
- Server-side problems or restrictions
- Third-party content or services
- Device damage or data on your device
