...
class BlowTorchForegroundService : Service() {
  ...
  override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
    val title = intent?.getStringExtra(EXTRA_TITLE) ?: "BlowTorch conectado"
  ...
  companion object {
    const val CHANNEL_ID = "blowtorch_background"
